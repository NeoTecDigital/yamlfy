...
/// Do what `yfi_core::bind::rebind` does: point every imported definition at
...
fn shape(parsed: &yfi_syntax::Parsed) -> (usize, usize, Vec<String>, Vec<Span>) {
    (
